...
from agent.utils.utils import human_input, check_no_human_mode
...
class HumanIncreaseWindowSizeAction(HumanSupervisionAction):
    keys = ["+"]
    description = "Increase window width"


class HumanDecreaseWindowSizeAction(HumanSupervisionAction):
    keys = ["-"]
...
class HumanSupervisionChecker:
    ...
    def get_actions(self) -> list[HumanSupervisionAction]:
        actions: list[HumanSupervisionAction] = [HumanIncreaseWindowSizeAction(), HumanDecreaseWindowSizeAction()]
